...
<body>
    <header class="my-header">
        ...
        <div style="position: relative; z-index: 1;">
            ...
            <br>
            <p style="font-size: 1.3rem;"><a href="">Home</a> / <a href="">Company Profile</a> / Edit Profile</p>
        </div>
    </header>
    <main>
        <section class="main-div">
            <h2 class="post_job_header">Edit Your Profile</h2>
            <div class="inner_div">

                <form action="EditProfileAction" method="post" enctype="multipart/form-data">
                    ...
                    <hr style="margin-top: 20px;">
                            ...
                            <div class="txt_feild">
                                <div class="profile_img">
                                    <!--setting the Employer ID-->
                                    <input type="hidden" name="EmployerID" value="${EmployerID}">
                                    
                                    <input type="hidden" value="${base64Image}" name="existing_logo">
                                    <img src='data:image/png;base64, ${base64Image}' alt="logo" name="existing_logo">
                                </div>
                                <div class="file-input-container">
                                    <button class="file-input-button">Change Image</button>
                            ...
                            <div class="txt_feild">
                                <input name="companyName" placeholder="Company Name" type="text" value="${companyName}" required>
                                <label for="">
                            ...
                            <div class="txt_feild">
                                ...
                                <textarea name="company_description" placeholder="Enter Company Description here..." name="company_description" id=""
                                          cols="30" rows="10">${company_description}</textarea>
                                <label for="">
                            ...
                            <div class="txt_feild">
                                <input name="company_location" placeholder="eg: No 5, Kanta Road EK House, Kaduna..." type="text" value="${company_location}"
                                       required>
                                <label for="">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="16" width="12"
                                         viewBox="0 0 384 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                            ...
                            <div class="txt_feild">
                                <input name="company_website" placeholder="Direct Link to Website eg: https://niitkaduna.ng.com..."
                                       type="text" value="${company_website}" required>
                                <label for="">
                            ...
                            <div class="txt_feild">
                                <input name="company_email" placeholder="abc@gmail.com"
                                       type="email" value="${company_email}" required>
                                <label for="">
                            ...
                            <div class="txt_feild">
                                <input name="companyPhoneNo" placeholder="+234 91 6122 230"
                                       type="text" value="${company_phoneNo}" required>
                                <label for="">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16"
                                         viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                    <path 
