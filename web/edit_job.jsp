        ...
        <section class="main-div">
            ...
            <div class="inner_div">
                <form action="EditJobAction" method="post">
                    ...
                    <div class="txt_feild">
                        <input placeholder="job title" type="text" value="${JobTitle}" name="jobTitle" required>
                        <label for="">
                    ...
                    <div class="txt_feild">
                        ...
                        <textarea name="description" placeholder="Enter Job Description here..."id="" cols="30"
                            rows="10">${JobDescription}</textarea>
                        <label for="">
                    ...
                    <div class="txt_feild">
                        <input name="location" placeholder="eg: No 5, Kanta Road EK House, Kaduna..." type="text" value="${Location}" required>
                        <label for="">
                            <svg xmlns="http://www.w3.org/2000/svg" height="16" width="12"
                                viewBox="0 0 384 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                <path
                    ...
                    <div class="txt_feild">
                        ...
                        <textarea name="Requirements" placeholder="Enter Job Requirements (Age, Experience, Knowledge e.t.c)" id=""
                            cols="30" rows="10">${jobRequirement}</textarea>
                        <label for="">
                            <svg xmlns="http://www.w3.org/2000/svg" height="16" width="12"
                                viewBox="0 0 384 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                <path
                    ...
                    <div class="txt_feild share">
                        <div>
                            <input name="salary" class="job_type_input" style="width: 70%;" placeholder="eg: 2000" type="number" value="${salary}" required>
                            <select name="sal_currency" class="job_type_option" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Job Type">
                                <option value="Naira (N)" ${currency eq 'Naira (N)' ? 'selected' : ''}>Naira (N)</option>
                                <option value="Dollars ($)" ${currency eq 'Dollars ($)' ? 'selected' : ''}>Dollars ($)</option>
                                 <option value="Others : Specify in Description Section" ${currency eq 'Check Description' ? 'selected' : ''}>Others : Specify in Description Section</option>
                            </select>
                        </div>
                    ...
                    <div class="txt_feild">
                        ...
                        <select name="nature" class="job_type_option job_nature" style="width: 100%;" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Job Type">
                            <option value="Remote ( Online )" ${JobNature eq 'Remote ( Online )' ? 'selected' : ''}>Remote ( Online )</option>
                            <option value="Onsite" ${JobNature eq 'Onsite' ? 'selected' : ''}>Onsite</option>
                            <option value="Others : Specify in Description Section" ${JobNature eq 'Check Description' ? 'selected' : ''}>Others : Specify in Description Section</option>
                        </select>
                        <label class="ahil" for="">
                            ...
                            nature
                                            ...
                                            <div class="txt_feild">
                            <input name="vacancy" placeholder="Number of Slots Available..." type="number" value="${vacancy}" required>
                            <label for="">
                    ...
                    <div class="txt_feild">
                        <input name="date" placeholder="you@yourdomainname.com" type="date" value="<%=new SimpleDateFormat("yyyy-MM-dd").format(date) %>" required>
                        <label for="">
