    ...
    <body>
        ...
        <main>
            <section class="main-div">
                <h2 class="post_job_header">Apply For A Job</h2>
                <div class="inner_div">
                    <form action="Application" method="post" enctype="multipart/form-data" >
                        <p class="form_heading_name">Email And Resume</p>
                        ...
                        <div class="txt_feild">
                            ...
                            <input type="file" name="file" id="" accept=".pdf, .doc, .docx" required>
                            <label for="">
                        ...
                        %>
                        <button style=" display: block; font-family: ubuntu; font-size: 20px; padding: 10px 20px; background-color: #fb246a; border: none; border-radius: 4px; color: white;" type="submit"> Apply </button>
                    </form>
                </div>
            </section>
        </main>
